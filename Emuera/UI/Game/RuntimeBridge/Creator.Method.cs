...
internal static partial class FunctionMethodCreator
{
	...
	private sealed class HtmlStringLenMethod : FunctionMethod
	{
		...
		{
			int len = RuntimeHost.HtmlLength(arguments[0].GetStrValue(exm));
	...
	private sealed class IsDefinedMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			return (RuntimeGlobals.IdentifierDictionary?.GetMacro(arguments[0].GetStrValue(exm)) != null) ? 1 : 0;
		}
	}
	private sealed class EnumNameMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			{
				case EType.Function:
					array = exm.Process?.LabelDictionary?.NoneventKeys ?? [];
					break;
				case EType.Variable:
					array = RuntimeGlobals.IdentifierDictionary?.VarKeys ?? [];
					break;
				case EType.Macro:
					array = RuntimeGlobals.IdentifierDictionary?.MacroKeys ?? [];
					break;
			}
			List<string> strs = [];
			if (arg.Length > 0)
	...
	private sealed class EnumFilesMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			try
			{
				...
				{
					files[i] = Path.GetRelativePath(RuntimeEnvironment.ExeDir, files[i]);
				}
	...
	private sealed class ExistVarMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			VariableToken token = RuntimeGlobals.IdentifierDictionary?.GetVariableToken(arguments[0].GetStrValue(exm), null, true);
			if (token != null)
			{
				long res = 0;
	...
	private sealed class HtmlSubStringMethod : FunctionMethod
	{
		...
		public override string GetStrValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			string[] strs = RuntimeHost.HtmlSubString(str, (int)arguments[1].GetIntValue(exm));
	...
	private sealed class DataTableSelectMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			long[] output = toResult ? exm.VEvaluator.RESULT_ARRAY : (arguments[3] as VariableTerm).Identifier.GetArray() as long[];
			if (res != null)
			{
	...
	private sealed class DataTableToXmlMethod : FunctionMethod
	{
		...
		public override string GetStrValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			if (!dict.ContainsKey(key)) return string.Empty;
			var dt = dict[key];
			var output = arguments.Count > 1 ? (arguments[1] as VariableTerm).Identifier.GetArray() as string[] : exm.VEvaluator.RESULTS_ARRAY;
	...
	private sealed class MoveTextBoxMethod : FunctionMethod
	{
		...
		bool resume;
			...
			{
				if (resume)
					RuntimeHost.ResetTextBoxPos();
				else
					RuntimeHost.SetTextBoxPos(
	...
	private sealed class VarsizeMethod : FunctionMethod
	{
		...
		//		string varName = ((SingleTerm)arguments[0]).Text;
			//		if (RuntimeGlobals.IdentifierDictionary.GetVariableToken(varName, null, true) == null)
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			VariableToken var = RuntimeGlobals.IdentifierDictionary?.GetVariableToken(arguments[0].GetStrValue(exm), null, true);
			if (var == null)
	...
	private sealed class CheckfontMethod : FunctionMethod
	{
		...
		{
			string str = arguments[0].GetStrValue(exm);
			return RuntimeHost.IsFontInstalled(str) ? 1 : 0;
		}
	...
	private sealed class MesSkipMethod : FunctionMethod
	{
		...
		public override string CheckArgumentType(string name, List<AExpression> arguments)
		{
			...
			if (warn)
				// ParserMediator.Warn("関数MOUSESKIP()は推奨されません。代わりに関数MESSKIP()を使用してください", RuntimeGlobals.CurrentScanningLine, 1, false, false, null);
				ParserMediator.Warn(string.Format(trerror.FuncDeprecated.Text, name, "MESSKIP"), RuntimeGlobals.CurrentScanningLine, 1, false, false, null);
			return null;
		}
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			return exm.Console.MesSkip ? 1L : 0L;
		}
	}
	...
	private sealed class GetColorMethod : FunctionMethod
	{
		...
		{
			if (defaultColor)
				return Config.ForeColorRuntime.ToRgb24();
			return RuntimeHost.GetStringColorRgb();
		}
	}
	...
	private sealed class GetFocusColorMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			return Config.FocusColorRuntime.ToRgb24();
		}
	}
	...
	private sealed class GetBGColorMethod : FunctionMethod
	{
		...
		{
			if (defaultColor)
				return Config.BackColorRuntime.ToRgb24();
			return RuntimeHost.GetBackgroundColorRgb();
		}
	}
	...
	private sealed class GetStyleMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			RuntimeFontStyleFlags fontstyle = RuntimeHost.GetStringStyleFlags();
			long ret = 0;
			if ((fontstyle & RuntimeFontStyleFlags.Bold) == RuntimeFontStyleFlags.Bold)
				ret |= 1;
			if ((fontstyle & RuntimeFontStyleFlags.Italic) == RuntimeFontStyleFlags.Italic)
				ret |= 2;
			if ((fontstyle & RuntimeFontStyleFlags.Strikeout) == RuntimeFontStyleFlags.Strikeout)
				ret |= 4;
			if ((fontstyle & RuntimeFontStyleFlags.Underline) == RuntimeFontStyleFlags.Underline)
				ret |= 8;
			return ret;
		}
	}
	...
	private sealed class GetFontMethod : FunctionMethod
	{
		...
		public override string GetStrValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			var fontName = RuntimeHost.GetFontName();
			return string.IsNullOrEmpty(fontName) ? Config.FontName : fontName;
		}
	}
	...
	private sealed class CurrentAlignMethod : FunctionMethod
	{
		...
		public override string GetStrValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			var alignment = RuntimeHost.GetAlignment();
			if (alignment == RuntimeDisplayLineAlignment.LEFT)
				return "LEFT";
			if (alignment == RuntimeDisplayLineAlignment.CENTER)
				return "CENTER";
			return "RIGHT";
		}
	}
	...
	private sealed class CurrentRedrawMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			return RuntimeHost.GetRedrawMode() == RuntimeRedrawMode.None ? 0L : 1L;
		}
	}
	...
	private sealed class ColorFromNameMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			if (RuntimeHost.TryResolveNamedColorRgb(colorName, out int rgb))
				return rgb;
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			if (!isCharaRange)
			{
				p.IsArrayRangeValid(index1, index2, "SUMARRAY", 2L, 3L);
					return VariableEvaluator.GetArraySum(p, index1, index2, exm);
			}
			else
			{
				...
				if (index1 >= charaNum || index1 < 0 || index2 > charaNum || index2 < 0)
					...
					return VariableEvaluator.GetArraySumChara(p, index1, index2, exm);
			}
		}
	}
			...
			if (!isCharaRange)
			{
				...
				if (arguments[0].GetOperandType() == typeof(long))
				{
					long targetValue = arguments[1].GetIntValue(exm);
						return VariableEvaluator.GetMatch(p, targetValue, start, end, exm);
				}
				else
				{
					string targetStr = arguments[1].GetStrValue(exm);
						return VariableEvaluator.GetMatch(p, targetStr, start, end, exm);
				}
			}
			else
			{
				...
				{
					long targetValue = arguments[1].GetIntValue(exm);
						return VariableEvaluator.GetMatchChara(p, targetValue, start, end, exm);
				}
				else
				{
					string targetStr = arguments[1].GetStrValue(exm);
						return VariableEvaluator.GetMatchChara(p, targetStr, start, end, exm);
				}
			}
		}
	...
	private sealed class MaxArrayMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			if (!isCharaRange)
			{
				...
				return VariableEvaluator.GetMaxArray(p, start, end, isMax, exm);
			}
			else
			{
				long charaNum = exm.VEvaluator.CHARANUM;
				...
				return VariableEvaluator.GetMaxArrayChara(p, start, end, isMax, exm);
			}
		}
	}
	...
	private sealed class InRangeArrayMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			if (!isCharaRange)
			{
				...
				return VariableEvaluator.GetInRangeArray(p, min, max, start, end, exm);
			}
			else
			{
				long charaNum = exm.VEvaluator.CHARANUM;
				if (start >= charaNum || start < 0 || end > charaNum || end < 0)
					...
					throw new CodeEE(string.Format(trerror.CharacterRangeInvalid.Text, Name, start, end));
				return VariableEvaluator.GetInRangeArrayChara(p, min, max, start, end, exm);
			}
		}
	}
		...
		public override string GetStrValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			switch (strType)
			{
				...
				case StrFormType.Half:
					return StringConversionCompat.ToNarrow(str, Config.Language);
				case StrFormType.Full:
					return StringConversionCompat.ToWide(str, Config.Language);
			}
			return "";
		}
	}
	...
	private sealed class LineIsEmptyMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			return RuntimeHost.IsLastLineEmpty() ? 1L : 0L;
		}
	}
	...
	private sealed class UnicodeMethod : FunctionMethod
	{
		...
		public override string GetStrValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			{
				//コード実行中の場合
				if (exm.Process.getCurrentLine != null)
					// exm.Console.PrintSystemLine("注意:" + RuntimeGlobals.CurrentScanningLine?.Position.Value.Filename + "の" + RuntimeGlobals.CurrentScanningLine?.Position.Value.LineNo.ToString() + "行目でUNICODE関数に制御文字に対応する値(0x" + String.Format("{0:X}", i) + ")が渡されました");
					exm.Console.PrintSystemLine(string.Format(trerror.WarnPrefix.Text,
						exm.Process.getCurrentLine.Position.Value.Filename,
						exm.Process.getCurrentLine.Position.Value.LineNo,
						string.Format(trerror.InvalidUnicode.Text, Name, i)));
				else
					//ParserMediator.Warn("UNICODE関数に制御文字に対応する値(0x" + String.Format("{0:X}", i) + ")が渡されました", RuntimeGlobals.CurrentScanningLine, 1, false, false, null);
					ParserMediator.Warn(string.Format(trerror.InvalidUnicode.Text, Name, i), RuntimeGlobals.CurrentScanningLine, 1, false, false, null);
				return "";
			}
	...
	public sealed class GetLineStrMethod : FunctionMethod
	{
		...
		public override string GetStrValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			return RuntimeHost.FormatDrawLineString(str);
		}
	}
	...
	public sealed class JoinMethod : FunctionMethod
	{
		...
		public override string GetStrValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			return VariableEvaluator.GetJoinedStr(p, delimiter, index1, index2, exm);
		}
		public override bool UniqueRestructure(ExpressionMediator exm, List<AExpression> arguments)
		{
	...
	private sealed class HtmlGetPrintedStrMethod : FunctionMethod
	{
		...
		public override string GetStrValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			return RuntimeHost.GetDisplayLineHtml(lineNo);
		}
	}
	...
	private sealed class HtmlPopPrintingStrMethod : FunctionMethod
	{
		...
		public override string GetStrValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			return RuntimeHost.PopDisplayLineHtml();
		}
	}
	...
	private sealed class HtmlToPlainTextMethod : FunctionMethod
	{
		...
		public override string GetStrValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			return RuntimeHost.HtmlToPlainText(arguments[0].GetStrValue(exm));
		}
	}
	private sealed class HtmlEscapeMethod : FunctionMethod
	{
		...
		public override string GetStrValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			return RuntimeHost.HtmlEscape(arguments[0].GetStrValue(exm));
		}
	}
	#endregion
	...
	private static GraphicsImage ReadGraphics(string Name, ExpressionMediator exm, List<AExpression> arguments, int argNo)
	{
		...
		return RuntimeHost.GetGraphics((int)target) as GraphicsImage;
	}
	/// <summary>
	...
	public static GraphicsImage ReadGraphics(int target)
	{
		...
		return RuntimeHost.GetGraphics(target) as GraphicsImage;
	}
	...
	public sealed class GraphicsSetFontMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			Font styledFont;
			if (!UiPlatformBridge.TryCreateFont(fontname, fontsize, fs, out styledFont))
				return 0;
	...
	public sealed class GraphicsDrawStringMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			if (font == null)
			{
				var styleFlags = RuntimeHost.GetStringStyleFlags();
				font = new Font(Config.FontName, 100, (FontStyle)(int)styleFlags, GraphicsUnit.Pixel);
			}
	...
	**/
	...
	public sealed class SpriteStateMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			ASprite img = RuntimeHost.GetSprite(imgname) as ASprite;
	...
	public sealed class ClientSizeMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			{
				case "CLIENTWIDTH":
					return RuntimeHost.GetConsoleClientWidth();
				case "CLIENTHEIGHT":
					return RuntimeHost.GetConsoleClientHeight();
			}
			...
			try
			{
				...
				if (!Path.IsPathRooted(filepath))
				{
					if (isRelative)
						...
						filepath = Path.Combine(RuntimeEnvironment.ContentDir, filename);
				}
	...
	public sealed class SpriteCreateMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			RuntimeHost.CreateSpriteG(imgname, g, new RuntimeRect(rect.X, rect.Y, rect.Width, rect.Height));
			return 1;
		}
	}
	...
	public sealed class SpriteDisposeMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			if (img == null || !img.IsCreated)
				return 0;
			RuntimeHost.SpriteDispose(imgname);
			return 1;
		}
	}
	...
	public sealed class SpriteDisposeAllMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			return RuntimeHost.SpriteDisposeAll(arguments[0].GetIntValue(exm) != 0);
		}
	}
	...
	public sealed class SpriteAnimeCreateMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			RuntimeHost.CreateSpriteAnime(imgname, pos.X, pos.Y);
			return 1;
		}
	}
	...
	public sealed class SpriteAnimeAddFrameMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			if (string.IsNullOrEmpty(imgname))
				return 0;
			if (RuntimeHost.GetSprite(imgname) == null)
				return 0;
			SpriteAnime img = RuntimeHost.GetSprite(imgname) as SpriteAnime;
			if (img == null || !img.IsCreated)
				return 0;
			GraphicsImage g = ReadGraphics(Name, exm, arguments, 1);
			if (!g.IsCreated)
	...
	public sealed class CBGRemoveRangeMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			unchecked
			{
				RuntimeHost.CbgClearRange((int)x64, (int)y64);
			}
			return 1;
		}
	}
	...
	public sealed class CBGSetGraphicsMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			if (!RuntimeHost.CbgSetGraphics(g, p.X, p.Y, (int)z64))
				return 0;
			return 1;
	...
	public sealed class CBGSetBMapGMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			if (!g.IsCreated || g.Bitmap == null)
				return 0;
			if (!RuntimeHost.CbgSetButtonMap(g))
				return 0;
			return 1;
	...
	public sealed class CBGSetCIMGMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			if (z64 < int.MinValue || z64 > int.MaxValue || z64 == 0)
				// throw new CodeEE(string.Format(Properties.Resources.RuntimeErrMesMethodDefaultArgumentOutOfRange0, Name, z64, 3 + 1));
				throw new CodeEE(string.Format(trerror.ArgIsOutOfRangeExcept.Text, Name, 4, z64, int.MinValue, int.MaxValue, 0));
			if (!RuntimeHost.CbgSetImage(img, p.X, p.Y, (int)z64))
				return 0;
			return 1;
	...
	public sealed class CBGSETButtonSpriteMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			ASprite imgN = RuntimeHost.GetSprite(imgnameN) as ASprite;
			string imgnameB = arguments[2].GetStrValue(exm);
			ASprite imgB = RuntimeHost.GetSprite(imgnameB) as ASprite;
			...
			if (!RuntimeHost.CbgSetButtonImage((int)b64, imgN, imgB, p.X, p.Y, (int)z64, tooltip))
				return 0;
			return 1;
	...
	private sealed class GetKeyStateMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			if (!RuntimeHost.IsConsoleActive())//アクティブでないならスルー
				return 0;
			long keycode = arguments[0].GetIntValue(exm);
			if (keycode < 0 || keycode > 255)
				return 0;
			short s = RuntimeHost.GetKeyState((int)keycode);
	...
	private sealed class MousePosMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			var mousePosition = RuntimeHost.GetMousePositionXY();
			switch (Name)
			{
				case "MOUSEX": return mousePosition.X;
				case "MOUSEY": return mousePosition.Y;
			}
	...
	private sealed class MouseButtonMethod : FunctionMethod
	{
		...
		public override string GetStrValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			return RuntimeHost.GetPointingButtonInput();
		}
	}
	#endregion
	...
	private sealed class IsActiveMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			return RuntimeHost.IsConsoleActive() ? 1 : 0;
		}
	}
	...
	private sealed class SetAnimeTimerMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			RuntimeHost.SetRedrawTimer((int)i64);
			return 1;
		}
	}
	...
	private sealed class ExistSoundMethod : FunctionMethod
	{
		...
		{
			string str = arguments[0].GetStrValue(exm);
			string filepath = RuntimeEnvironment.ResolveSoundPath(str);
			if (File.Exists(filepath))
				return 1;
			return 0;
		}
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			if (arguments.Count == 1 || arguments[1].GetIntValue(exm) == 0)
			{
				...
				if (Config.StringComparison == StringComparison.OrdinalIgnoreCase)
					func = RuntimeGlobals.LabelDictionary?.GetNonEventLabel(functionname.ToUpper());
				else
					func = RuntimeGlobals.LabelDictionary?.GetNonEventLabel(functionname);
				if (func == null)
					return 0;
				if (func.IsMethod)
				{
			...
			{
				foreach (string funcname in exm.Process.LabelDictionary.NoneventKeys)
				{
					if (funcname.ToUpper() == functionname.ToUpper())
					{
						FunctionLabelLine func = exm.Process.LabelDictionary.GetNonEventLabel(funcname);
	...
	private sealed class GetTextBoxMethod : FunctionMethod
	{
		public GetTextBoxMethod()
		{
			...
			public override string GetStrValue(ExpressionMediator exm, List<AExpression> arguments)
			{
				return RuntimeHost.GetTextBoxText();
			}
		}
	private sealed class ChangeTextBoxMethod : FunctionMethod
	{
		public ChangeTextBoxMethod()
		{
			...
			public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
			{
				RuntimeHost.ChangeTextBox(arguments[0].GetStrValue(exm));
				return 1;
			}
		}
	#endregion
	...
	private sealed class GetDisplayLineMethod : FunctionMethod
	{
		...
		public override string GetStrValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			return RuntimeHost.GetDisplayLineText(num);
		}
	}
	#endregion
	...
	private sealed class GetMethMethod : FunctionMethod
	{
		...
		public override Int64 GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			var term = RuntimeGlobals.IdentifierDictionary?.GetFunctionMethod(RuntimeGlobals.LabelDictionary, name, methArgs, true);
	...
	private sealed class ExistMethMethod : FunctionMethod
	{
		...
		public override Int64 GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			try
			{
				term = RuntimeGlobals.IdentifierDictionary?.GetFunctionMethod(RuntimeGlobals.LabelDictionary, name, new List<AExpression>(), true);
			}
			catch (CodeEE)
			{
				return 0;
	...
	private sealed class BitmapCacheEnableMethod : FunctionMethod
	{
		...
		public override long GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			RuntimeHost.SetBitmapCacheEnabledForNextLine(argument0 != 0);
			return 0;
		}
	}
	#endregion
	...
	private sealed class HotkeyStateMethod : FunctionMethod
	{
		public HotkeyStateMethod()
		{
			...
			public override Int64 GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
			{
				...
				RuntimeHost.HotkeyStateSet((nint)argument0, (nint)argument1);
				return 0;
			}
		}
	...
	private sealed class HotkeyStateInitMethod : FunctionMethod
	{
		public HotkeyStateInitMethod()
		{
			...
			{
				Int64 argument0 = arguments[0].GetIntValue(exm);
				RuntimeHost.HotkeyStateInit((nint)argument0);
				return 0;
			}
		}
	...
	private sealed class OutputlogMethod : FunctionMethod
	{
		...
		public override Int64 GetIntValue(ExpressionMediator exm, List<AExpression> arguments)
		{
			...
			return RuntimeHost.OutputLog(filename, hideInfo) ? 1 : 0;
		}
